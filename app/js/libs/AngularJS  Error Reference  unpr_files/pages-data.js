...
angular.module('pagesData', [])
  ...
  "api/ng/function/angular.reloadWithDebugInfo": {
    ...
    "searchTerms": {
      ...
      "keywords": "$compileprovider angular api application call current debug debuginfoenabled function js js-angular-master ng precedence reload reloadwithdebuginfo src takes turned"
    }
  },
  ...
  "api/ng/input/input[week]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute browser browsers case changes constraint control createdateinputtype data-bind default defined directive element entered error evaluates example example-week-input-directive executed expression form format greater html5 input instance interaction iso iso-8601 js js-angular-master key max min model ng ngchange ngmodel ngmodeloptions ngrequired object property published read required sets src support text timezone transformation true user valid validation week week-of-the-year"
    }
  },
  ...
  "api/ng/directive/ngFocus": {
    ...
    "searchTerms": {
      ...
      "keywords": "$apply $evalasync $event angularjs api behavior calling consistent custom directive ensure evaluate event executed executes expression fired focus guide input js js-angular-master ng ngclick ngeventdirs ngfocus note object scope select src synchronously textarea window"
    }
  },
  ...
  "error/$q/norslvr": {
    ...
    "searchTerms": {
      ...
      "keywords": "$q calling creating docs error function js-angular-master ngdoc norslvr occurs passed promise providing reject required resolver var waitforsomethingasync"
    }
  },
  "error/$q/qcycle": {
    "docType": "error",
    ...
    "searchTerms": {
      "titleWords": "$q:qcycle",
      "keywords": "$q behavior defer docs error function https including js-angular-master mandates ngdoc occurs passed promise qcycle resolve resolving return returning spec the-promise-resolution-procedure throw typeerror var"
    }
  },
  ...
  "error/ngRepeat/badident": {
    ...
    "searchTerms": {
      ...
      "keywords": "$even $first $last $middle $odd $parent alias assign badident collection collections declare directive docs error expression expressions filter filteredcollection foo html identifier include invalid item items js-angular-master names ng ng-repeat ngdoc ngrepeat null objects occurs processed property reserved resultofsomemethod scope simple syntax thrown undefined valid var"
    }
  },
